...
public class AndroidMissingNativesHandler extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		String message = "Reclaimed Pixel Dungeon failed to access some of its internal code and cannot start!\n\n" +
				"Try rebuilding or reinstalling this copy of the game. You can also screenshot this debug info for troubleshooting:";
