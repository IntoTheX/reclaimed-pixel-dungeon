...
public class ShatteredPixelDungeon extends Game {
	...
	//Reclaimed still accepts legacy saves from this version onward.
	public static final int v2_5_4 = 802;

	//Upstream migration markers retained for version-specific conversions.
	...
	public ShatteredPixelDungeon( PlatformSupport platform ) {
		...
		com.watabou.utils.Bundle.addAlias(
				com.erebus.reclaimedpixeldungeon.items.keys.WornKey.class,
				"com.erebus.reclaimedpixeldungeon.items.keys.SkeletonKey" );
