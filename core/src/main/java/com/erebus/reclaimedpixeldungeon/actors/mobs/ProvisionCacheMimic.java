...
public class ProvisionCacheMimic extends GoldenMimic {

	{
		spriteClass = MimicSprite.ProvisionCache.class;
	}

	@Override
	public String name() {
		return alignment == Alignment.NEUTRAL
				? Messages.get(Heap.class, "provision_cache")
	...
	public String description() {
		...
		String desc = Messages.get(Heap.class, "provision_cache_desc");
