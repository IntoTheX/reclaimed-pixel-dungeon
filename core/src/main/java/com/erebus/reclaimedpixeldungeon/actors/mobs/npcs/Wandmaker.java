...
import com.erebus.reclaimedpixeldungeon.levels.rooms.quest.MassGraveRoom;
import com.erebus.reclaimedpixeldungeon.levels.rooms.quest.RitualSiteRoom;
import com.erebus.reclaimedpixeldungeon.levels.rooms.quest.RotGardenRoom;
...
import com.erebus.reclaimedpixeldungeon.windows.WndWandmaker;
...
public class Wandmaker extends NPC {
	...
	public static class Quest {
		...
		public static ArrayList<Room> spawnRoom( ArrayList<Room> rooms) {
			...
			if (!spawned && (type != 0 || (generationDepth > 6 && Random.Int( 10 - generationDepth ) == 0))) {
