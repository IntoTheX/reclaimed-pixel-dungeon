...
import com.erebus.reclaimedpixeldungeon.items.armor.ClericArmor;
import com.erebus.reclaimedpixeldungeon.items.armor.ClothArmor;
import com.erebus.reclaimedpixeldungeon.items.armor.DuelistArmor;
import com.erebus.reclaimedpixeldungeon.items.armor.HuntressArmor;
import com.erebus.reclaimedpixeldungeon.items.armor.LeatherArmor;
import com.erebus.reclaimedpixeldungeon.items.armor.MageArmor;
...
import com.erebus.reclaimedpixeldungeon.items.armor.RogueArmor;
import com.erebus.reclaimedpixeldungeon.items.armor.ScaleArmor;
import com.erebus.reclaimedpixeldungeon.items.armor.WarriorArmor;
...
import com.erebus.reclaimedpixeldungeon.items.potions.elixirs.Elixir;
...
import com.erebus.reclaimedpixeldungeon.items.stones.StoneOfAetherflux;
...
import com.erebus.reclaimedpixeldungeon.items.stones.StoneOfBlast;
import com.erebus.reclaimedpixeldungeon.items.stones.StoneOfBlink;
import com.erebus.reclaimedpixeldungeon.items.stones.StoneOfClairvoyance;
import com.erebus.reclaimedpixeldungeon.items.stones.StoneOfDeepSleep;
import com.erebus.reclaimedpixeldungeon.items.stones.StoneOfDetectMagic;
import com.erebus.reclaimedpixeldungeon.items.stones.StoneOfEnchantment;
import com.erebus.reclaimedpixeldungeon.items.stones.StoneOfFateweaver;
import com.erebus.reclaimedpixeldungeon.items.stones.StoneOfFear;
import com.erebus.reclaimedpixeldungeon.items.stones.StoneOfFlock;
import com.erebus.reclaimedpixeldungeon.items.stones.StoneOfFracturedNexus;
import com.erebus.reclaimedpixeldungeon.items.stones.StoneOfIntuition;
import com.erebus.reclaimedpixeldungeon.items.stones.StoneOfNullbrand;
import com.erebus.reclaimedpixeldungeon.items.stones.StoneOfOblivionSeal;
import com.erebus.reclaimedpixeldungeon.items.stones.StoneOfPrismforge;
import com.erebus.reclaimedpixeldungeon.items.stones.StoneOfReforgeConflux;
import com.erebus.reclaimedpixeldungeon.items.stones.StoneOfReshapersCrucible;
import com.erebus.reclaimedpixeldungeon.items.stones.StoneOfShock;
import com.erebus.reclaimedpixeldungeon.items.trinkets.ChaoticCenser;
import com.erebus.reclaimedpixeldungeon.items.trinkets.CrackedSpyglass;
import com.erebus.reclaimedpixeldungeon.items.trinkets.DimensionalSundial;
import com.erebus.reclaimedpixeldungeon.items.trinkets.ExoticCrystals;
import com.erebus.reclaimedpixeldungeon.items.trinkets.EyeOfNewt;
...
import com.erebus.reclaimedpixeldungeon.items.trinkets.MossyClump;
...
import com.erebus.reclaimedpixeldungeon.items.trinkets.ThirteenLeafClover;
import com.erebus.reclaimedpixeldungeon.items.trinkets.TrapMechanism;
...
import com.erebus.reclaimedpixeldungeon.items.trinkets.WondrousResin;
...
import com.erebus.reclaimedpixeldungeon.items.weapon.melee.AssassinsBlade;
import com.erebus.reclaimedpixeldungeon.items.weapon.melee.BattleAxe;
...
import com.erebus.reclaimedpixeldungeon.items.weapon.melee.Dirk;
import com.erebus.reclaimedpixeldungeon.items.weapon.melee.Flail;
import com.erebus.reclaimedpixeldungeon.items.weapon.melee.Gauntlet;
import com.erebus.reclaimedpixeldungeon.items.weapon.melee.Glaive;
import com.erebus.reclaimedpixeldungeon.items.weapon.melee.Gloves;
import com.erebus.reclaimedpixeldungeon.items.weapon.melee.Greataxe;
import com.erebus.reclaimedpixeldungeon.items.weapon.melee.Greatshield;
import com.erebus.reclaimedpixeldungeon.items.weapon.melee.Greatsword;
import com.erebus.reclaimedpixeldungeon.items.weapon.melee.HandAxe;
import com.erebus.reclaimedpixeldungeon.items.weapon.melee.Katana;
import com.erebus.reclaimedpixeldungeon.items.weapon.melee.Longsword;
import com.erebus.reclaimedpixeldungeon.items.weapon.melee.Mace;
...
import com.erebus.reclaimedpixeldungeon.items.weapon.melee.Quarterstaff;
...
import com.erebus.reclaimedpixeldungeon.items.weapon.melee.Sai;
import com.erebus.reclaimedpixeldungeon.items.weapon.melee.Scimitar;
import com.erebus.reclaimedpixeldungeon.items.weapon.melee.Shortsword;
import com.erebus.reclaimedpixeldungeon.items.weapon.melee.Sickle;
import com.erebus.reclaimedpixeldungeon.items.weapon.melee.Spear;
import com.erebus.reclaimedpixeldungeon.items.weapon.melee.Sword;
import com.erebus.reclaimedpixeldungeon.items.weapon.melee.WarHammer;
import com.erebus.reclaimedpixeldungeon.items.weapon.melee.WarScythe;
import com.erebus.reclaimedpixeldungeon.items.weapon.melee.Whip;
...
public class Generator {
	...
	public enum Category {
		...
		static {
			...
			STONE.classes = new Class<?>[]{
					...
					StoneOfReforgeConflux.class,
					StoneOfAetherflux.class,
					StoneOfFracturedNexus.class,
					StoneOfReshapersCrucible.class,
					StoneOfOblivionSeal.class,
					StoneOfFateweaver.class,
					StoneOfNullbrand.class,
					StoneOfPrismforge.class
			};
			STONE.defaultProbs = new float[]{ 0, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 0, 1, 1, 1, 1, 1, 1, 0.45f, 1 };
	...
	public static Item random( Category cat ) {
		switch (cat) {
			...
			default:
				...
				return ((Item) Reflection.newInstance(itemCls)).random().randomizeRarityStats();
		}
	}
	...
	public static Item random( Class<? extends Item> cl ) {
		return Reflection.newInstance(cl).random().randomizeRarityStats();
	}

	@SuppressWarnings("unchecked")
	public static Item randomRarityCatalyst() {
		Class<?>[] catalysts = new Class<?>[]{
				StoneOfReforgeConflux.class,
				StoneOfAetherflux.class,
				StoneOfFracturedNexus.class,
				StoneOfReshapersCrucible.class,
		...
		float[] chances = new float[]{ 1, 1, 1, 1, 1, 1, 0.45f, 1 };
		int index = Random.chances( chances );
		if (index < 0) index = Random.Int( catalysts.length );
		return random( (Class<? extends Item>)catalysts[index] );
	}
	...
	public static Armor randomArmor(int floorSet) {
		...
		a.random();
		return (Armor)a.randomizeRarityStats();
	}
	...
	public static Artifact randomArtifact() {
		...
		cat.probs[i]--;
		return (Artifact) Reflection.newInstance((Class<? extends Artifact>) cat.classes[i]).random().randomizeRarityStats();
