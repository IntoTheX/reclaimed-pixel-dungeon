...
public class RarityStat {
	...
	public enum Type {
		...
		ARTIFACT_RECHARGE_RATE( "Artifact Recharge Rate", true ),
		...
		public String compactDisplayName() {
			switch (this) {
				...
				case ARTIFACT_RECHARGE_RATE: return "Artifact Regen";
		...
		public String description() {
			switch (this) {
				...
				case RESOURCEFUL:
					return "Increases the quantity of material and forge-resource stacks generated by dungeon rewards. The full percentage remains effective beyond 100%.";
				case SOUL_REAPING:
				...
				case TREASURE_LUCK:
					return "Increases normal monster loot chance up to 5 drops per enemy. Every 1000% also guarantees one rarity-tier improvement for rarity-capable drops, with partial progress rolled toward another tier. This does not affect chest rewards or gold stack size.";
				case UNBREAKABLE:
				...
				case ARTIFACT_RECHARGE_RATE:
					return "Increases this artifact's natural recharge rate.";
				default:
