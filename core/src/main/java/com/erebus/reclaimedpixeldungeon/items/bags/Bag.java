...
import com.erebus.reclaimedpixeldungeon.windows.WndQuickBag;
	...
	public boolean collect( Bag container ) {
		...
		if (super.collect( container )) {
			...
			if (this instanceof MaterialSatchel
					|| this instanceof TrinketBag
					|| this instanceof KeyHolder
					|| this instanceof ArtifactBag
					|| this instanceof FoodBag) {
				ReclaimedTutorial.flash( Document.GUIDE_BAGS_STORAGE );
			}
