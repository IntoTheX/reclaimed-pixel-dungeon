...
public abstract class CatalystStone extends Item {
	...
	protected void onThrow(int cell) {
		...
		if (this instanceof CatalystStone ||
	...
	public boolean doPickUp( Hero hero, int pos ) {
		...
		if (pickedUp && this instanceof RarityCatalystStone) {
			ReclaimedTutorial.flash( Document.GUIDE_CATALYSTS );
		}
		return pickedUp;
	}
	...
	public static class PlaceHolder extends CatalystStone {
		...
		public boolean isSimilar(Item item) {
			return item instanceof CatalystStone;
		}
