...
public abstract class Trinket extends Item {
	...
	public boolean collect( Bag container ) {
		...
		if (collected) refreshActiveRarityStats();
		return collected;
	}
	...
	protected void onDetach() {
		super.onDetach();
		refreshHeroMaxHealth();
	}

	@Override
	protected void onRarityStatsChanged() {
		super.onRarityStatsChanged();
		refreshActiveRarityStats();
	}

	private void refreshActiveRarityStats() {
		if (Dungeon.hero != null && Dungeon.hero.belongings != null && Dungeon.hero.belongings.contains( this )) {
			refreshHeroMaxHealth();
		}
	}

	private void refreshHeroMaxHealth() {
	...
	protected static int trinketLevel(Class<? extends Trinket> trinketType ){
		...
		Trinket trinket = Dungeon.hero.belongings.getActiveTrinket(trinketType);
	...
	public static class UpgradeTrinket extends Recipe {
		...
		public Item brew(ArrayList<Item> ingredients) {
			...
			result.improveRarityStatsFromUpgrade();
