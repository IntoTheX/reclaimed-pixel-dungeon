...
package com.erebus.reclaimedpixeldungeon.items.weapon.melee;
...
public class MagesStaff extends MeleeWeapon {
	...
	private void syncWandRarityStats() {
		if (wand != null && hasRarityRoll()) wand.inheritRarityStatsFrom( this );
	}
	...
	public void updateWand(boolean levelled){
		if (wand != null) {
			...
			wand.maxCharges = Math.max(1, wand.maxCharges + 1);
