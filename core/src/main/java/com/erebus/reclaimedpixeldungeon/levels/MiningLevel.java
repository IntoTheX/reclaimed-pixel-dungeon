...
import com.erebus.reclaimedpixeldungeon.actors.mobs.FungalSpinner;
...
import com.erebus.reclaimedpixeldungeon.levels.painters.MiningLevelPainter;
import com.erebus.reclaimedpixeldungeon.levels.painters.Painter;
import com.erebus.reclaimedpixeldungeon.levels.rooms.Room;
import com.erebus.reclaimedpixeldungeon.levels.rooms.quest.MineEntrance;
...
public class MiningLevel extends CavesLevel {
	...
	public float respawnCooldown() {
		...
		return threatAdjustedRespawnCooldown( 3*TIME_TO_RESPAWN );
	}
