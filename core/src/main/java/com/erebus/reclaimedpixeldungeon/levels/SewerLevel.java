...
import com.erebus.reclaimedpixeldungeon.scenes.SurfaceScene;
...
public class SewerLevel extends RegularLevel {
	...
	public boolean activateTransition(Hero hero, LevelTransition transition) {
		if (Dungeon.depth == 1 && transition.type == LevelTransition.Type.SURFACE) {
			return super.activateTransition( hero, new LevelTransition(
					this,
					transition.cell(),
