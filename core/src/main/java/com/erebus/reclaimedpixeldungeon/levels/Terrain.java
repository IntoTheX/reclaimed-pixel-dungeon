...
public class Terrain {
	...
	public static final int HOMEBASE_SHORT_GRASS = 39;
	public static final int HOMEBASE_MEDIUM_GRASS = 40;
	public static final int HOMEBASE_TALL_GRASS = 41;
	public static final int HOMEBASE_DIRT_EDGE = 42;
	public static final int HOMEBASE_GRASS_DIRT_EDGE = 43;
	...
	static {
		...
		flags[HOMEBASE_SHORT_GRASS] = flags[EMPTY];
		flags[HOMEBASE_MEDIUM_GRASS] = flags[EMPTY];
		flags[HOMEBASE_TALL_GRASS] = flags[EMPTY];
		flags[HOMEBASE_DIRT_EDGE] = flags[EMPTY];
		flags[HOMEBASE_GRASS_DIRT_EDGE] = flags[EMPTY];
