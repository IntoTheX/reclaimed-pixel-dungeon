...
import com.erebus.reclaimedpixeldungeon.actors.mobs.npcs.LostDefender;
...
public class LockedDefenderRescueRoom extends SpecialRoom {
	...
	public void paint( Level level ) {
		...
		LostDefender defender = new LostDefender();
		defender.pos = (left + right) / 2 + (top + bottom) / 2 * level.width();
		level.mobs.add( defender );
