...
public class AboutScene extends PixelScene {
	...
	public void create() {
		...
		//*** Reclaimed Pixel Dungeon Credits ***

		CreditsBlock shpx = new CreditsBlock(true, Window.SHPX_COLOR,
				"Reclaimed Pixel Dungeon",
				Icons.RECLAIMED.get(),
				"A GPLv3 fork of _Shattered Pixel Dungeon_.\nOriginal Shattered Pixel Dungeon by: _Evan Debenham_\nBased on Pixel Dungeon's open source.",
				null,
				null);
		if (landscape()){
		...
		CreditsBlock gdx = new CreditsBlock(true,
				...
				"libGDX",
				Icons.LIBGDX.get(),
				"Reclaimed Pixel Dungeon is powered by _libGDX_!",
				"libgdx.com",
				"https://libgdx.com/");
		if (landscape()){
		...
		CreditsBlock transifex = new CreditsBlock(true,
				...
				null,
				null,
				"Reclaimed Pixel Dungeon uses Shattered Pixel Dungeon's community translation base via _Transifex_. Thank you so much to all of Shattered's volunteer translators!",
		...
		CreditsBlock freesound = new CreditsBlock(true,
				...
				null,
				null,
				"Reclaimed Pixel Dungeon uses the following sound samples from _freesound.org_:\n\n" +
