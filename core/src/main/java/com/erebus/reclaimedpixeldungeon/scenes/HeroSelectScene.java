...
import com.erebus.reclaimedpixeldungeon.ui.OptionSlider;
...
import com.erebus.reclaimedpixeldungeon.windows.WndHeroInfo;
...
import com.erebus.reclaimedpixeldungeon.windows.WndTextInput;
							...
							if (index == 0){
								promptForCharacterName( new Runnable() {
									...
									public void run() {
										...
										//earliest possible daily for the v4.0 baseline is Apr 01 2026
