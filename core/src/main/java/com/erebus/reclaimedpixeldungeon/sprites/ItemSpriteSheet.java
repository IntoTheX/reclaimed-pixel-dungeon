...
public class ItemSpriteSheet {
	...
	private static void assignItemRect( int item, int x, int y, int width, int height ){
		film.add( item, x, y, x+width, y+height);
	}
	...
	public static final int STONE_REFORGE_CONFLUX     = STONES+12;
	public static final int STONE_AETHERFLUX           = STONES+13;
	public static final int STONE_FRACTURED_NEXUS      = STONES+14;
	public static final int STONE_RESHAPERS_CRUCIBLE   = STONES+15;
	private static final int CATALYST_STONES           = xy(9, 32);  //4 free document-row slots
	public static final int STONE_OBLIVION_SEAL        = CATALYST_STONES+0;
	public static final int STONE_FATEWEAVER           = CATALYST_STONES+1;
	public static final int STONE_NULLBRAND            = CATALYST_STONES+2;
	public static final int STONE_PRISMFORGE           = CATALYST_STONES+3;
	static {
		for (int i = STONES; i < STONES+16; i++)
			assignItemRect(i, 14, 12);
		assignItemRect(STONE_OBLIVION_SEAL, 14, 12);
		assignItemRect(STONE_FATEWEAVER, 14, 12);
		assignItemRect(STONE_NULLBRAND, 14, 12);
		assignItemRect(STONE_PRISMFORGE, 14, 12);
	}
	...
	public static final int BUILDING_WOOD   = SCROLLS+14;
	public static final int BUILDING_STONE  = SCROLLS+15;
	public static final int BUILDING_COPPER = POTIONS+12;
	public static final int BUILDING_IRON   = POTIONS+14;
	public static final int BUILDING_GOLD   = POTIONS+15;
	static {
		assignItemRect(BUILDING_WOOD,   14, 12);
		assignItemRect(BUILDING_STONE,  13, 12);
		assignItemRect(BUILDING_COPPER, 12, 12);
		assignItemRect(BUILDING_IRON,   12, 12);
		assignItemRect(BUILDING_GOLD,   12, 12);
	}
	...
	private static final int HOMEBASE_RESOURCE_ICONS = 10000;
	public static final int HOMEBASE_WOOD       = HOMEBASE_RESOURCE_ICONS+0;
	public static final int HOMEBASE_STONE      = HOMEBASE_RESOURCE_ICONS+1;
	public static final int HOMEBASE_COPPER     = HOMEBASE_RESOURCE_ICONS+2;
	public static final int HOMEBASE_IRON       = HOMEBASE_RESOURCE_ICONS+3;
	public static final int HOMEBASE_GOLD       = HOMEBASE_RESOURCE_ICONS+4;
	...
	static {
		...
		assignItemRect(HOMEBASE_COPPER, 208, 371, 8, 7);
		assignItemRect(HOMEBASE_IRON,   216, 371, 8, 7);
		assignItemRect(HOMEBASE_GOLD,   224, 371, 8, 7);
	...
	public static final int FORGE_SCRAP         = SEEDS+12;
	public static final int FORGE_EMBER_SHARD   = SEEDS+13;
	public static final int FORGE_EMBER_CORE    = SEEDS+14;
	static{
		for (int i = SEEDS; i < SEEDS+16; i++)
			assignItemRect(i, 10, 10);
		assignItemRect(FORGE_SCRAP,       14, 12);
		assignItemRect(FORGE_EMBER_SHARD, 16, 12);
		assignItemRect(FORGE_EMBER_CORE,  13, 13);
	}
	...
	public static final int MATERIAL_SATCHEL = BAGS+7;
	public static final int TRINKET_BAG = BAGS+8;
	public static final int KEY_HOLDER  = BAGS+9;
	public static final int ARTIFACT_BAG = BAGS+10;
	public static final int FOOD_BAG = BAGS+11;
	static{
		...
		assignItemRect(MATERIAL_SATCHEL, 15, 16);
		assignItemRect(TRINKET_BAG, 15, 16);
		assignItemRect(KEY_HOLDER,  14, 14);
		assignItemRect(ARTIFACT_BAG, 15, 16);
		assignItemRect(FOOD_BAG,    15, 16);
	}
	...
	public static class Icons {
		...
		public static final int SCROLL_RETURN   = SCROLLS+12;
		static {
			...
			assignIconRect( SCROLL_RETURN,      7, 7 );
		}
