...
package com.erebus.reclaimedpixeldungeon.tiles;
...
public class DungeonTileSheet {
	...
	public static final int HOMEBASE_DIRT_EDGE = GROUND +5;
	...
	public static final int HOMEBASE_DIRT_EDGE_ALT = GROUND +11;

	public static final int MINE_FLOOR_DECO_HEAVY_ALT   = GROUND +11;

	public static final int FLOOR_ALT_2     = GROUND +12;
	public static final int HOMEBASE_GRASS_DIRT_EDGE = GROUND +13;
	public static final int HOMEBASE_GRASS_DIRT_EDGE_ALT = GROUND +14;
	...
	static {
		...
		chasmStitcheable.put( Terrain.HOMEBASE_SHORT_GRASS, CHASM_FLOOR );
		chasmStitcheable.put( Terrain.HOMEBASE_MEDIUM_GRASS, CHASM_FLOOR );
		chasmStitcheable.put( Terrain.HOMEBASE_TALL_GRASS, CHASM_FLOOR );
		chasmStitcheable.put( Terrain.HOMEBASE_DIRT_EDGE, CHASM_FLOOR );
		chasmStitcheable.put( Terrain.HOMEBASE_GRASS_DIRT_EDGE, CHASM_FLOOR );
	...
	public static HashSet<Integer> waterStitcheable = new HashSet<>(Arrays.asList(
			...
			Terrain.HOMEBASE_SHORT_GRASS, Terrain.HOMEBASE_MEDIUM_GRASS, Terrain.HOMEBASE_TALL_GRASS,
			Terrain.HOMEBASE_DIRT_EDGE, Terrain.HOMEBASE_GRASS_DIRT_EDGE
	));
	...
	static {
		...
		directVisuals.put(Terrain.HOMEBASE_SHORT_GRASS, GRASS);
		directVisuals.put(Terrain.HOMEBASE_MEDIUM_GRASS, FLOOR_DECO);
		directVisuals.put(Terrain.HOMEBASE_TALL_GRASS, FLOOR_SP);
		directVisuals.put(Terrain.HOMEBASE_DIRT_EDGE, HOMEBASE_DIRT_EDGE);
		directVisuals.put(Terrain.HOMEBASE_GRASS_DIRT_EDGE, HOMEBASE_GRASS_DIRT_EDGE);
	...
	static {
		...
		tileAltVisuals.put(HOMEBASE_DIRT_EDGE, new tileAlt(new float[]{50f}, HOMEBASE_DIRT_EDGE_ALT));
		tileAltVisuals.put(HOMEBASE_GRASS_DIRT_EDGE, new tileAlt(new float[]{50f}, HOMEBASE_GRASS_DIRT_EDGE_ALT));
