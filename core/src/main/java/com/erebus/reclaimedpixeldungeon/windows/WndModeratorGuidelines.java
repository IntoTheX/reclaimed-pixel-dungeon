...
public class WndModeratorGuidelines extends WndTabbed {
	...
	private static String rewards() {
		return "_THANK YOU FOR SHOWING UP_\n\n"
				...
				+ "_DAILY APPRECIATION_\nEach completed active hour unlocks one choice: _5 random Catalysts_, _20 random Resources_, or _2 Emeralds_. You can earn up to three daily choices, and your progress can be continued throughout the same UTC day.\n\n"
				+ "_WEEKLY APPRECIATION_\nReach _15 active hours_ during the UTC week to choose _50 random Catalysts_, _1000 random Resources_, _1 Spatial Geode_, or _5 Ascendant Sparks_. Active time beyond the three rewarded daily hours still helps complete this goal.\n\n"
