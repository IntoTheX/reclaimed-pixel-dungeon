...
import com.erebus.reclaimedpixeldungeon.scenes.SupporterScene;
...
public class WndSupportPrompt extends Window {
	...
	public WndSupportPrompt(){
		...
		IconTitle title = new IconTitle(Icons.get(Icons.RECLAIMED), Messages.get(WndSupportPrompt.class, "title"));
